...
public class InlineTableExecutors {
  ...
  private SnapshotsAndFilesCleaningExecutor snapshotsAndFilesCleaningExecutor;
  ...
  public void setup(TableService tableService, Configurations conf) {
    if (conf.getBoolean(AmoroManagementConf.EXPIRE_SNAPSHOTS_ENABLED)
      ...
      this.snapshotsAndFilesCleaningExecutor =
          new SnapshotsAndFilesCleaningExecutor(
              tableService,
              conf.getInteger(AmoroManagementConf.CLEAN_SNAPSHOTS_AND_FILES_THREAD_COUNT),
              conf.get(AmoroManagementConf.CLEAN_SNAPSHOTS_AND_FILES_INTERVAL));
    }
  ...
  public SnapshotsAndFilesCleaningExecutor getSnapshotsAndFilesCleaningExecutor() {
    return snapshotsAndFilesCleaningExecutor;
  }
