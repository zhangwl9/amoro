...
public class SnapshotsAndFilesCleaningExecutor extends PeriodicTableScheduler {
  private static final Logger LOG =
      LoggerFactory.getLogger(SnapshotsAndFilesCleaningExecutor.class);

  private final long interval;

  public SnapshotsAndFilesCleaningExecutor(
  ...
  public void execute(DefaultTableRuntime tableRuntime) {
    try {
      ...
      // executed
      if (tableRuntime.getTableConfiguration().isDeleteDanglingDeleteFilesEnabled()) {
      ...
      // to get the latest status of the table
