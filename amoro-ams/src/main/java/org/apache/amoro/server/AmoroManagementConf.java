...
public class AmoroManagementConf {
  ...
  public static final ConfigOption<Boolean> EXPIRE_SNAPSHOTS_ENABLED =
      ConfigOptions.key("clean-snapshots-and-files.expire-snapshots.enabled")
          .booleanType()
          .defaultValue(true)
          .withDescription("Enable snapshots expiring.");

  public static final ConfigOption<Integer> CLEAN_SNAPSHOTS_AND_FILES_THREAD_COUNT =
      ConfigOptions.key("clean-snapshots-and-files.thread-count")
          .intType()
          .defaultValue(10)
          .withDescription("The number of threads used for cleaning snapshots and files.");

  public static final ConfigOption<Duration> CLEAN_SNAPSHOTS_AND_FILES_INTERVAL =
      ConfigOptions.key("clean-snapshots-and-files.interval")
          .durationType()
          .defaultValue(Duration.ofDays(1))
          .withDescription("Execute interval for cleaning snapshots and files");

  public static final ConfigOption<Boolean> CLEAN_ORPHAN_FILES_ENABLED =
      ConfigOptions.key("clean-snapshots-and-files.clean-orphan-files.enabled")
          .booleanType()
          .defaultValue(true)
          .withDescription("Enable orphan files cleaning.");

  public static final ConfigOption<Boolean> CLEAN_DANGLING_DELETE_FILES_ENABLED =
      ConfigOptions.key("clean-snapshots-and-files.clean-dangling-delete-files.enabled")
          .booleanType()
          .defaultValue(true)
          .withDescription("Enable dangling delete files cleaning.");

  public static final ConfigOption<Boolean> DATA_EXPIRATION_ENABLED =
      ConfigOptions.key("clean-snapshots-and-files.data-expiration.enabled")
          .booleanType()
          .defaultValue(true)
