...
public class TestAmoroManagementConfValidator {
  ...
  public void testValidateThreadCount() {
    ...
    configurations.setInteger(AmoroManagementConf.CLEAN_SNAPSHOTS_AND_FILES_THREAD_COUNT, -1);
    Assert.assertThrows(
        IllegalArgumentException.class,
        () -> AmoroManagementConfValidator.validateConfig(configurations));
    configurations.setInteger(AmoroManagementConf.CLEAN_SNAPSHOTS_AND_FILES_THREAD_COUNT, 10);
    AmoroManagementConfValidator.validateConfig(configurations);
